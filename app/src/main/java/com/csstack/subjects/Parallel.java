...
import com.csstack.subjects.units.ParallelUnits.PARALLEL1;
import com.csstack.subjects.units.ParallelUnits.PARALLEL2;
import com.csstack.subjects.units.ParallelUnits.PARALLEL3;
import com.csstack.subjects.units.ParallelUnits.PARALLEL4;
import com.csstack.subjects.units.ParallelUnits.PARALLEL5;
 ...
 */
public class Parallel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textView.setText(R.string.parallel);
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 2:
                    return new PARALLEL3();


                case 3:
                    return new PARALLEL4();

                case 4:
                    return new PARALLEL5();
