...
import com.csstack.subjects.units.ParadigmUnits.PARADIGM1;
import com.csstack.subjects.units.ParadigmUnits.PARADIGM2;
import com.csstack.subjects.units.ParadigmUnits.PARADIGM3;
import com.csstack.subjects.units.ParadigmUnits.PARADIGM4;
import com.csstack.subjects.units.ParadigmUnits.PARADIGM5;
...
public class PPFrag extends Fragment {
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    return new PARADIGM1();

                case 1:
                    return new PARADIGM2();

                case 2:
                    return new PARADIGM3();


                case 3:
                    return new PARADIGM4();

                case 4:
                    return new PARADIGM5();
