package com.csstack.subjects.units.ParallelUnits;
 ...
 */
public class PARALLEL1 extends Fragment implements pointsAdapter.PositionClick{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        points.add("Parallel Computer Models");
