package com.csstack.subjects.units.OOADunits;
 ...
 */
public class OOAD5 extends Fragment implements pointsAdapter.PositionClick{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        points.add("More Patterns");
        points.add("Analysis update");
