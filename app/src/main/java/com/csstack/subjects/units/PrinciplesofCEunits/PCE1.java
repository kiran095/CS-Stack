package com.csstack.subjects.units.PrinciplesofCEunits;
 ...
 */
public class PCE1 extends Fragment implements pointsAdapter.PositionClick{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        points.add("Characterstics of computers");
        points.add("Evlution of computers");
        points.add("Evaluation of computers");
