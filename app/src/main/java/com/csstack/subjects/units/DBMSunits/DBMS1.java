package com.csstack.subjects.units.DBMSunits;
 ...
 */
public class DBMS1 extends Fragment implements pointsAdapter.PositionClick{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        points.add("Data");
        points.add("Evolution of DB & DBMS");
        points.add("Data models & Database Architecture");
