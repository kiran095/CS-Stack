package com.csstack.subjects.units.Cplusunits;
 ...
 */
public class CPLUS4 extends Fragment implements pointsAdapter.PositionClick{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        points.add("Templates");
        points.add("Name Spaces");
        points.add("Casting");
        points.add("Exeception Handling");
